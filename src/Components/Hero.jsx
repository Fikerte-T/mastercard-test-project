    ...
    <div className='flex justify-center py-20 sm:py-0 md:py-0 lg:py-30 text-white'>
        <div className='text-center flex flex-col items-center justify-center lg:space-y-10 space-y-6 w-[75%] lg:w-[60%]'>
            ...
            <div className='flex space-x-10'>
                <button className='rounded-sm bg-button text-sm px-2 md:px-4 md:text-base py-2 hover:bg-button/50'>Find Your Tutor</button>
                <button className='rounded-sm bg-button text-sm px-2 md:px-4 md:text-base py-2 hover:bg-button/50'>Featured Tutors</button>
            </div>
        </div>
    </div>
  )
